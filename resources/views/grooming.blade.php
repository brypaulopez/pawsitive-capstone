...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row text-center mt-3" style="margin: auto;">
            ...
            <div class="col-12 col-xl-2 mt-1"><a href="/grooming" class="btn bglorange w-100 rounded-pill bteal" id="category">Grooming</a></div>
                    ...
                    <div class="col-12 col-lg-6 col-xl-3 col-md-6">
                        <div class="card bsblack blorange">
                            <a href="products/{{$g -> product_id}}">
                                <img src="img/products/{{$g -> product_image}}" style="width: 302px; height: 201px;" class="card-img-top w-100" alt="...">
                            </a>
                            <div class="card-body">
