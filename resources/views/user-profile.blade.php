...
<<<<<<< HEAD
                <img src="/img/user-icon.png" alt="" class="bblack rounded-circle bsblack">
=======
                <img src="/img/user-icon.png" alt="" class="bblack rounded-circle">
>>>>>>> fa6cf4ce271b64c594c553842e6f1d2f46090884
...
<<<<<<< HEAD
                        <textarea name="review" id="" cols="150" rows="10" placeholder="Write a review..."></textarea>
=======
